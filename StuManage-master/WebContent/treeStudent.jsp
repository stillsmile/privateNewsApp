...
var treeMenu = [
	{ level:1, name:"学生"},
	{ level:2, name:"学生信息", ico:"images/icon_default.gif",link:"Proscenium_Query"},
	{ level:1, name:"选课"},
	{ level:2, name:"课程列表", ico:"images/icon_default.gif",link:"CourseQueryServlet"},
	{ level:2, name:"已选课程", ico:"images/icon_default.gif",link:"AlreadyServlet"},
	{ level:1, name:"系统管理"},
	{ level:2, name:"密码修改", ico:"images/icon_default.gif",link:"student_update_password.jsp"},
	{ level:2, name:"安全退出", ico:"images/icon_default.gif",link:"DropLogin?dropInfo=student"},
