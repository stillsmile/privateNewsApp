...
var manageAutohrity="${manageAutohrity}"
var treeMenu=null;
if(manageAutohrity=="教师"){
	treeMenu = [
            	{ level:1, name:"学生管理"},
            	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"StudentQuery"},
            	{ level:1, name:"课程管理"},
            	{ level:2, name:"课程列表", ico:"images/icon_default.gif",link:"CourseServlet?message=query"}, 
            	{ level:1, name:"系统管理"},
            	{ level:2, name:"安全退出", ico:"images/icon_default.gif",link:"DropLogin?dropInfo=manage"},
            ];
}else if(manageAutohrity=="管理员"){
	treeMenu = [
	            	{ level:1, name:"学生管理"},
	            	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"StudentQuery"},
	            	{ level:1, name:"课程管理"},
	            	{ level:2, name:"课程列表", ico:"images/icon_default.gif",link:"CourseServlet?message=query"},
	            	{ level:1, name:"教师管理"},
	            	{ level:2, name:"教师列表", ico:"images/icon_default.gif",link:"TeacherServlet"},
	            	{ level:1, name:"系统管理"},
	            	{ level:2, name:"安全退出", ico:"images/icon_default.gif",link:"DropLogin?dropInfo=manage"},
	            ];
}
...
#menuControll a:hover{ 
	color:#FE9901;
}
</style>
<div id="menuControll">
菜单栏显示:【<a href="#" onclick="tree.openAll();this.blur();return false;" style="text-decoration:none">展开</a>】【<a href="#" onclick="tree.closeAll();this.blur();return false;" style="text-decoration:none">折叠</a>】
</div>
